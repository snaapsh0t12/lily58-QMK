 ...
 */
 ...
 [_NEW_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                        MO(_LOWER), KC_LALT, KC_LGUI, KC_SPC, KC_ENT, KC_BSPC, KC_RGUI, DF(_QWERTY)
),
 ...
 */
[_LOWER] = LAYOUT( \
  CLOSE_WINDOW, _______, _______, _______, _______, _______,                   _______, _______, _______,_______, _______, _______,\
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, \
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD, \
  _______, DF(_NEW_QWERTY),     CUT,   COPY, PASTE, _______, _______, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
 ...
 oled_set_cursor(0, 1);
  ...
  switch (get_highest_layer(layer_state)) {
    ...
    case _ADJUST:
      ...
      break;
    case _NEW_QWERTY:
      oled_write(PSTR("NEW QWERTY"), false);
      break;
    default:
